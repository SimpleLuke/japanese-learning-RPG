    ...
    <>
      <div className="h-screen w-screen bg-charBg bg-cover bg-center mx-auto">
        <div className="mb-10 mt-44 w-96 bg-red-300 p-4 border-4 border-gray-900 mx-auto">
          <h1 data-test="page-title" className="pixel-font">
        ...
        <div className="flex flex-wrap justify-center w-96 mx-auto h-80 bg-red-100 border-4 border-gray-900">
          ...
          <div className="w-1/2 p-4 flex mt-12 justify-center">
            <div className="justify-center" data-test="character-styles">
              <div className="pb-2">
                <div
                  className="hair-button mb-4"
                  onClick={() => {
                    flickThrough(hairStyleIndex, setHairStyleIndex, hairStyles);
                  }}
                ></div>
              </div>
              <div className="pb-2">
                <div
                  className="top-button mb-4"
                  onClick={() => {
                    flickThrough(topStyleIndex, setTopStyleIndex, topStyles);
                  }}
                ></div>
              </div>
              <div className="pb-2">
                <div
                  className="pants-button mb-4"
                  onClick={() => {
                    flickThrough(
                      bottomStyleIndex,
                      setBottomStyleIndex,
              ...
              <div className="pb-2">
                <div
                  className="shoes-button mb-4"
                  onClick={() => {
                    flickThrough(shoeStyleIndex, setShoeStyleIndex, shoeStyles);
                  }}
                ></div>
              </div>
            </div>
          ...
          <button
            onClick={() => {
              storeOutfit(charData);
            }}
            data-test="submitChosenCharacter"
            type="submit"
